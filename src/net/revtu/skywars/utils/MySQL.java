package net.revtu.skywars.utils;

import net.revtu.skywars.SkyWars;
import net.revtu.skywars.libraries.converters.ConvertersAPI;
import net.revtu.skywars.arena.ArenaDat;
import net.revtu.skywars.libraries.language.Language;
...
public class MySQL {
    ...
    public void createMySQL() {
        try {
            ...
            /* Core - Player, PlayTime, PlayersVisible, Chat, Points, NumberBans, NumberJoins, NumberKicks, NumberMutes, NumberReports */
